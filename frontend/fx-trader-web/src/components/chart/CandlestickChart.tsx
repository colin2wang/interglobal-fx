...
export const CandlestickChart = ({ data, height = 500 }: Props) => {
  ...
  useEffect(() => {
    ...
    chartInstance.current.setOption({
      ...
      grid: [{ left: '10%', right: '8%', height: '60%' }, { left: '10%', right: '8%', top: '75%', height: '16%' }],
      xAxis: [
      ...
      series: [
        ...
        { name: 'Volume', type: 'bar', xAxisIndex: 1, yAxisIndex: 1, data: volumes,
          itemStyle: { color: (params: any) => { const d = data[params.dataIndex]; return d.close >= d.open ? '#ef5350' : '#26a69a'; } } },
      ],
    });
  }, [data]);
