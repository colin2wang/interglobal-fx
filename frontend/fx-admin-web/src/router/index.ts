  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Deposit',
        component: () => import('@/views/account/deposit.vue'),
        meta: { title: 'Deposit' },
      },
      {
      ...
      {
        path: 'customer/:id/kyc',
        name: 'CustomerKyc',
        component: () => import('@/views/customer/kyc.vue'),
        meta: { title: 'KYC Review' },
      },
      {
        path: 'ib',
        name: 'IB',
        component: () => import('@/views/ib/list.vue'),
        meta: { title: 'IBs' },
      },
      {
        path: 'ib/commission',
        name: 'IBCommission',
        component: () => import('@/views/ib/commission.vue'),
        meta: { title: 'IB Commission' },
      },
      {
        path: 'risk',
        name: 'Risk',
        component: () => import('@/views/risk/rules.vue'),
        meta: { title: 'Risk Rules' },
      },
      {
        path: 'risk/events',
        name: 'RiskEvents',
        component: () => import('@/views/risk/events.vue'),
        meta: { title: 'Risk Events' },
      },
      {
        path: 'risk/blacklist',
        name: 'Blacklist',
      ...
      },
      {
        path: 'quote/symbols',
        name: 'QuoteSymbols',
        component: () => import('@/views/quote/symbols.vue'),
